#' @title Pairwise Document Distance Rank Plot
#' @description Document pair distance ranking plots.
#'
#' @param distance_rank_test_results The ouptu from the distance_rank_test()
#' function.
...
#' @return A plot
#' @export
distance_rank_plot <- function(distance_rank_test_results,
    ...
    results <- distance_rank_test_results$dfm_level_results
    data <- data.frame(Coefficient = results$difference*multiplier,
